...
from yolo3.mobilenetv3_base import relu6, hard_swish
...
def _main():
    ...
    if is_tiny_version:
        ...
        model = create_model(input_shape, anchors, num_classes,
            freeze_body=-1, load_pretrained=False, weights_path='logs/000/backup.h5') # make sure you know what you freeze
...
def create_model(input_shape, anchors, num_classes, load_pretrained=False, freeze_body=2,
    ...
    image_input = Input(shape=(input_shape[0], input_shape[0], 3))
    h, w = input_shape
...
def create_tiny_model(input_shape, anchors, num_classes, load_pretrained=False, freeze_body=-1,
